...
data = {"job": jobs, "advertiser": advertisers,  "description": descriptions, "classification": classifications,  "salary": salarys, "location": locations, "link": links, "source": seeks }
...
for x in range(len(jobs)):
    values_string = '(' + "'" + str(data['job'][x]).replace("'","''") + "'" + ', ' + "'" + str(data['advertiser'][x]).replace("'","''") + "'" + ', ' + "'" + str(data['description'][x]).replace("'","''") + "'" + ', ' + "'" + str(data['classification'][x]).replace("'","''") + "'" + ', ' + "'" + str(data['salary'][x]).replace("'","''") + "'" + ', ' + "'" + str(data['location'][x]).replace("'","''") + "'" + ', ' + "'" + str(data['link'][x]) + "'" + ', ' + "'" + str(data['source'][x]) + "'" + ')'
